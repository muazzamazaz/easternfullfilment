...
<body>
  ...
  <header id="header" class="fixed-top " style="padding-top: 50px;">
    <div class="container  align-items-center">
      <center><a href="index.html" class="logo me-auto"><img src="/assets/images/KEYSHOT.1 (1).png" alt="" class="img-fluid"/></a></center>
      ...
      <div class="container" >
        <div class="col-lg-12 justify-content-center pt-lg-0 order-1 order-lg-1" data-aos="fade-up" data-aos-delay="200">
          <div class="alert alert-danger" style="display:none"></div>
            ...
            <form id="registerForm" method="POST" action="{{ route('register_eastern') }}">@csrf
              <div class="row">
                <div class="col-md-6">
  ...
  // $('#registerForm').submit(function(e){
    ...
    window.location.href =data.redirect;
        ...
        $(".alert-danger").css("display", "block");
            $(".alert-danger").append(xhr.responseJSON.message);
