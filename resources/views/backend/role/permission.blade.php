                    ...
                    <div class="card-body">
						...
						<div class="table-responsive">
						    <table class="table table-bordered permission-table">
								...
								<tr>
						            <td>{{trans('file.Integration')}}</td>
						            <td class="text-center">
						                <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                @if(in_array("integrations-index", $all_permission))
								                <input type="checkbox" value="1" id="integrations-index" name="integrations-index" checked>
								                @else
								                <input type="checkbox" value="1" id="integrations-index" name="integrations-index">
								                @endif
								                <label for="integrations-index"></label>
							                </div>
							            </div>
						            </td>
						            <td class="text-center">
						                <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                @if(in_array("purchases-add", $all_permission))
								                <input type="checkbox" value="1" id="integrations-add" name="integrations-add" checked>
								                @else
								                <input type="checkbox" value="1" id="integrations-add" name="integrations-add">
								                @endif
								                <label for="integrations-add"></label>
							                </div>
							            </div>
						            </td>
						            <td class="text-center">
						                <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                @if(in_array("integrations-edit", $all_permission))
								                <input type="checkbox" value="1" id="integrations-edit" name="integrations-edit" checked />
								                @else
								                <input type="checkbox" value="1" id="integrations-edit" name="integrations-edit">
								                @endif
								                <label for="integrations-edit"></label>
							                </div>
							            </div>
						            </td>
						            <td class="text-center">
						                <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                @if(in_array("integrations-delete", $all_permission))
								                <input type="checkbox" value="1" id="integrations-delete" name="integrations-delete" checked>
								                @else
								                <input type="checkbox" value="1" id="integrations-delete" name="integrations-delete">
								                @endif
								                <label for="integrations-delete"></label>
							            	</div>
						            	</div>
						            </td>
						        </tr>
						        ...
						        <tr>
						            ...
						            <td class="report-permissions" colspan="5">
										...
										<span>
						                    <div aria-checked="false" aria-disabled="false">
								                <div class="checkbox">
							                    	@if(in_array("integration", $all_permission))
							                    	<input type="checkbox" value="1" id="integration" name="integration" checked>
							                    	@else
							                    	<input type="checkbox" value="1" id="integration" name="integration">
							                    	@endif
								                    <label for="integration" class="padding05">{{trans('file.Integration')}} &nbsp;&nbsp;</label>
								                </div>
								            </div>
						                </span>
										...
										<span>
						                    <div aria-checked="false" aria-disabled="false">
								                <div class="checkbox">
							                    	@if(in_array("packing", $all_permission))
							                    	<input type="checkbox" value="1" id="packing" name="packing" checked>
							                    	@else
							                    	<input type="checkbox" value="1" id="packing" name="packing">
							                    	@endif
								                    <label for="packing" class="padding05">{{trans('file.Packing')}} &nbsp;&nbsp;</label>
								                </div>
								            </div>
						                </span>
						        ...
						        <tr>
						            ...
						            <td class="report-permissions" colspan="5">
										...
										<span>
						                    <div aria-checked="false" aria-disabled="false">
								                <div class="checkbox">
							                    	@if(in_array("sale-ship", $all_permission))
							                    	<input type="checkbox" value="1" id="sale-ship" name="sale-ship" checked>
							                    	@else
							                    	<input type="checkbox" value="1" id="sale-ship" name="sale-ship">
							                    	@endif
								                    <label for="sale-ship" class="padding05">{{trans('file.Ship')}} &nbsp;&nbsp;</label>
								                </div>
								            </div>
						                </span>
						            </td>
