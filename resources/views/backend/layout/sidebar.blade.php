        <ul id="side-main-menu" class="side-menu list-unstyled">
            <li><a href="{{url('/dashboard')}}"> <i class="dripicons-meter"></i><span>Home</span></a></li>
            ...
            <li><a href="#sale" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-cart"></i><span>Orders</span></a>
            <ul id="sale" class="collapse list-unstyled ">
                @if($sale_index_permission_active)
                <li id="sale-list-menu"><a href="{{route('sales.index')}}">All Orders</a></li>
                @endif
                @if($sale_add_permission_active)
                    ...
                    <li id="sale-import-menu"><a href="{{route('sales.create')}}">{{trans('Work Orders')}}</a></li>
                    <li id="sale-import-menu"><a href="{{route('sales.create')}}">{{trans('Rules')}}</a></li>
            ...
            ?>
            @if($index_permission_active)
            <li><a href="#purchase" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-card"></i><span>{{trans('Inventory')}}</span></a>
            <ul id="purchase" class="collapse list-unstyled ">
                <li id="purchase-list-menu"><a href="{{route('purchases.index')}}">{{trans('Inventory List')}}</a></li>
                <?php
                $add_permission_active = $role_has_permissions_list->where('name', 'purchases-add')->first();
                ?>
                @if($add_permission_active)
                <li id="purchase-create-menu"><a href="{{route('purchases.create')}}">{{trans('Add Inventory')}}</a></li>
                <li id="purchase-import-menu"><a href="{{url('purchases/purchase_by_csv')}}">{{trans('Import Inventory By CSV')}}</a></li>
                @endif
            </ul>
            </li>
            @endif
            <?php
                $index_permission_active = $role_has_permissions_list->where('name', 'integrations-index')->first();
            ?>
            @if($index_permission_active)
        
            
            
            <li><a href="#integration" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-card"></i><span>{{trans('Integration')}}</span></a>
          
            <ul id="integration" class="collapse list-unstyled ">
                  <li id="integration-menu"><a href="{{route('integrations.create')}}">{{trans('Create')}}</a></li>
                <li id="integration-menu"><a href="{{route('integrations.index')}}">{{trans('Integrations List')}}</a></li>
            </ul>
            </li>
            @endif
            <?php
           ...
           <!-- muazzam <li><a href="#return" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-return"></i><span>{{trans('file.return')}}</span></a>-->
            <ul id="return" class="collapse list-unstyled ">
                @if($sale_return_index_permission_active)
                <li id="sale-return-menu"><a href="{{route('return-sale.index')}}">{{trans('Orders')}}</a></li>
                @endif
                @if($purchase_return_index_permission_active)
                <li id="purchase-return-menu"><a href="{{route('return-purchase.index')}}">{{trans('Inventory')}}</a></li>
                @endif
            </ul>
            </li>
            @endif
            ...
            <li><a href="#setting" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-gear"></i><span>{{trans('file.settings')}}</span></a>
                <ul id="setting" class="collapse list-unstyled ">
                   <?php
                        ...
                        $integration_permission_active = $role_has_permissions_list->where('name', 'integration')->first();

                        $packing_permission_active = $role_has_permissions_list->where('name', 'packing')->first();
                    ...
                    @if($integration_permission_active)
                    <li id="integration-menu"><a href="{{route('integration.index')}}">{{trans('file.IntegrationType')}}</a></li>
                    @endif

                    @if($packing_permission_active)
                    <li id="packing-menu"><a href="{{route('packing.index')}}">{{trans('file.Packing')}}</a></li>
                    @endif
