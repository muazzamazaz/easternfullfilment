                    ...
                    <div class="card-body">
                        ...
                        <form id="product-form">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Re-order Point</strong> </label>
                                        <input type="text" name="reorder_point" class="form-control" id="reorder_point" aria-describedby="reorder_point" required>
                                ...
                                <!--</div>-->
                                <div class="col-md-8">
                                    <label>Dimensions (in inches)</strong> </label>
                                    <div class="row">
                                    <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="input-group">
                                ...
                                <div class="col-md-4">
                                    <label>Weights</strong> </label>
                                    <div class="row">
                                    <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="input-group">
                                            <input type="number" class="form-control" id="lbz" name="lbz">
                                            <div class="input-group-prepend">
                                              <div class="input-group-text">lbz</div>
                                            </div>
                                        </div>
                                    </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            <input type="number" class="form-control" id="oz" name="oz">
                                            <div class="input-group-prepend">
