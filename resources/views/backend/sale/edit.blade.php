                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>{{trans('file.Packing')}} *</label>{{$lims_sale_data->packing_id}}
                                            <input type="hidden" name="packing_id_hidden" value="{{$lims_sale_data->packing_id}}" />
                                            <select required name="packing_id" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Select Packing...">
                                                @foreach($lims_packing_list as $packing)
                                                <option value="{{$packing->id}}">{{$packing->name . ' (' . $packing->size .', '. $packing->width.', '. $packing->height .', '. $packing->width .')'}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
...
<script type="text/javascript">
   ...
   // $('select[name="warehouse_id"]').val($('input[name="warehouse_id_hidden"]').val());
    $('select[name="packing_id"]').val($('input[name="packing_id_hidden"]').val());
