...
class PackingController extends Controller
{
    ...
    public function index()
    {
        ...
        $lims_warehouse_all = Packing::where('is_active', true)->get();
        $numberOfWarehouse = Packing::where('is_active', true)->count();
        return view('backend.packing.create', compact('lims_unit_all','lims_warehouse_all', 'numberOfWarehouse'));
    }
    ...
    public function store(Request $request)
    {
        ...
        Packing::create($input);
        $this->cacheForget('warehouse_list');
        return redirect('packing')->with('message', 'Data inserted successfully');
    }

    public function edit($id)
    {
        $lims_packing_data = Packing::findOrFail($id);
        return $lims_packing_data;
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $input = $request->all();
        $lims_warehouse_data = Packing::find($input['packing_id']);
        $lims_warehouse_data->update($input);
        $this->cacheForget('warehouse_list');
        return redirect('packing')->with('message', 'Data updated successfully');
    }
    ...
    public function deleteBySelection(Request $request)
    {
        ...
        foreach ($warehouse_id as $id) {
            $lims_warehouse_data = Packing::find($id);
    ...
    public function destroy($id)
    {
        ...
        $lims_warehouse_data->save();
        $this->cacheForget('warehouse_list');
        return redirect('packing')->with('not_permitted', 'Data deleted successfully');
    }
